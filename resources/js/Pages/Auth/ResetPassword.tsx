      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold text-white">Wachtwoord resetten</h2>
            <p className="mt-2 text-zinc-400">Vul je nieuwe wachtwoord in om je account te herstellen</p>
          </div>
          ...
          <form onSubmit={submit} className="mt-8 space-y-6">
            <div className="space-y-4">
              ...
              {/* Password */}
              <div className="space-y-2">
                <InputLabel htmlFor="password" value="Nieuw wachtwoord" className="text-white" />
                <TextInput
                  id="password"
                  type="password"
                  name="password"
              ...
              {/* Confirm Password */}
              <div className="space-y-2">
                <InputLabel htmlFor="password_confirmation" value="Bevestig wachtwoord" className="text-white" />
                <TextInput
