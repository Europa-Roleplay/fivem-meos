            ...
            <div className="hidden lg:block lg:w-1/2 relative">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-start p-12 z-20">
                    ...
                    <p className="text-xl text-white/80 max-w-md">
                        Mobiel Effectief Op Straat - Het centrale
                        informatiesysteem voor wetshandhaving in Nederland.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
                <div className="w-full max-w-md space-y-8">
                    ...
                    <form onSubmit={submit} className="mt-8 space-y-6">
                        ...
                        {/* Submit */}
                        <PrimaryButton
                            className="w-full bg-blue-600 hover:bg-blue-500 text-white font-semibold py-2 px-4 rounded disabled:opacity-50 transition"
                            disabled={processing}
                        >
                            Log in
                        </PrimaryButton>
